...
public:
    ...
    float&  accelX = accelData[0];                          // Acceleration aliases
    ...
    bool init();
    bool dataReady(); // If initialised? Ready to read data
    float* accel(); // Accel data pointer
    float* gyro(); // Gyro data pointer
    float temp();
